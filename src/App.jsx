        ...
        >
          ...
          transform transition-transform ${showModal ? 'translate-x-0' : 'translate-x-full'}`}>
            ...
            <div className='bg-stone-300 rounded-lg p-1'>
              <p className=' font-semibold px-2 pb-1'>Name:(Max length 16)</p>
              <input maxLength={16} className='outline-none w-full rounded-md p-2 bg-white' type="text" value={projectName} onChange={(e)=>setprojectName(e.target.value)} />
            </div>
            {/* Project desc */}
